...
const GameSetup = () => {
  return (
    <>
      ...
      <SetupForm />
      <Leader h4text="Prepare for Jenga!" h4textcol="col s9 m5" atts="" moveButton={<a href="/gameplay" className={`waves-effect waves-light btn-large col s4 m3 valign-wrapper purple lighten-1 buttons`}>START GAME<i className="large material-icons"></i></a>} />
    </>
  )
}
