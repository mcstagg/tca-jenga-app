    ...
    <>
      <div className={`row blue darken-1 header mbp valign-wrapper game-head`}>
        ...
        <button
          ...
          onClick={moveHandler}
        >
          MOVE<i className="large material-icons"></i>
        </button>
        <a
          href="/postGame"
        ...
        >
          JENGA!<i className="large material-icons"></i>
        </a>
        <a
          href="/"
          ...
          onClick={quitHandler}
        >
          QUIT<i className="large material-icons"></i>
        </a>
      </div>
      ...
      <div>
        <form>
          <h3 className="center turn">{currentPlayerName}'s Turn</h3>
