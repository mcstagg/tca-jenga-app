...
const PostGame = () => {
  return (
    <>
      ...
      <Results />
      <Leader h4text="Rematch?" h4textcol="col s4" atts="" moveButton={<a href="/gameplay" className={`waves-effect waves-light btn-large col s4 offset-s1 valign-wrapper deep-orange darken-1 buttons`}>Rematch<i className="material-icons"></i></a>} quitButton={<a href="/" className={`waves-effect waves-light btn-large col s4 valign-wrapper purple lighten-1 buttons`}>QUIT<i className="large"></i></a>} />
    </>
  )
}
